...
def generate_trade_signal(symbol):
    ...
    try:
        ...
        # 7. ✅ Signal-Filter prüfen
        conditions = [
            isinstance(latest_rsi, (int, float)) and 30 < latest_rsi < 70,
            isinstance(atr, (int, float)) and atr > 0,
            isinstance(volume, (int, float)) and volume > 100_000,
            isinstance(gap, (int, float)) and abs(gap) < 0.05
        ]
